...
<form action="" method="POST" enctype="multipart/form-data">
    <div id="inputs_left">
        ...
        <!-- <label for="infracao">Responsavel</label><br>
        <select name="Responsavel" id="veiculo">
            <option value="">Datas de reservas semelhantes</option>
            <?php foreach($responsavel as $info):?>
                <option value="<?php echo $info["responsavel"];?>" name="item"><?php echo $info["funcionario"];?></option>
            <?php endforeach;?>
        </select><br><br> -->
